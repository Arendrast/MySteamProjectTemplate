...
namespace VContainer.Unity
{
    ...
    public partial class LifetimeScope : MonoBehaviour, IDisposable
    {
        ...
        protected virtual async UniTask ConfigureAsync(IContainerBuilder builder) { }
        ...
        public async UniTask BuildAsync()
        {
            ...
            if (Parent != null)
            {
                ...
                var didInstalled = false;
                
                // ReSharper disable once PossibleNullReferenceException
                Parent.Container.CreateScopeAsync(async builder =>
                {
                    ...
                    await InstallToAsync(builder);

                    didInstalled = true;
                });

                await UniTask.WaitWhile(() => !didInstalled);
            }
            else
            {
        ...
        async UniTask InstallToAsync(IContainerBuilder builder)
        {
        ...
        protected virtual LifetimeScope GetRuntimeParent()
        {
