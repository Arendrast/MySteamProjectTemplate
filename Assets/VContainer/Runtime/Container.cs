...
namespace VContainer
{
    public interface IObjectResolver : IDisposable
    {
        ...
        IScopedObjectResolver CreateScopeAsync(Action<IContainerBuilder> installation = null);
    ...
    public sealed class ScopedContainer : IScopedObjectResolver
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public IScopedObjectResolver CreateScopeAsync(Action<IContainerBuilder> installation = null)
        {
    ...
    public sealed class Container : IObjectResolver
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public IScopedObjectResolver CreateScopeAsync(Action<IContainerBuilder> installation = null)
            => rootScope.CreateScopeAsync(installation);
