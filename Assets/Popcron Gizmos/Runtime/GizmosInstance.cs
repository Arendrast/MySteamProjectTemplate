...
namespace Popcron
{
    ...
    public class GizmosInstance : MonoBehaviour
    {
        ...
        /// </summary>
        internal static void Submit(Vector3[] points, int pointsCount, Color? color, bool dashed)
        {
            GizmosInstance inst = GetOrCreate();
            ...
            inst.queue[inst.queueIndex].pointsCount = pointsCount;
        ...
        private void OnRendered(Camera camera)
        {
            ...
            for (int e = 0; e < queueIndex; e++)
            {
                try
                {
                    ...
                    {
                        //subdivide
                        for (int i = 0; i < element.pointsCount - 1; i++)
                        {
                    ...
                    {
                        for (int i = 0; i < element.pointsCount; i++)
                        {
                            points.Add(element.points[i]);
                        }
                    }
                ...
                {
                    ArrayPool<Vector3>.Shared.Return(queue[e].points);
                }
            }
