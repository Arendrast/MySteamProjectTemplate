...
namespace Heathen.SteamworksIntegration
{
    ...
    {
        /// <summary>
        /// Filter the displayed friends for the <see cref="SteamFriendsListUI"/>
        /// </summary>
        public enum Filter
        {
            All,
...
#if UNITY_EDITOR
    [UnityEditor.CustomEditor(typeof(SteamFriendsListUI), true)]
    public class SteamFriendsListUIEditor : UnityEditor.Editor
    {
