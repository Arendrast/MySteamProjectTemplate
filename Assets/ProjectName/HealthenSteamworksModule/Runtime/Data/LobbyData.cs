...
namespace Heathen.SteamworksIntegration
{
    ...
    public struct LobbyData : IEquatable<CSteamID>, IEquatable<ulong>, IEquatable<LobbyData>
    {
        ...
        /// </summary>
        public readonly bool Full => IsValid && API.Matchmaking.Client.GetLobbyMemberLimit(id) <= SteamMatchmaking.GetNumLobbyMembers(this);
        /// <summary>
        ...
        public static void Create(ELobbyType type, SteamLobbyModeType mode, int slots, Action<EResult, LobbyData, bool> callback) => API.Matchmaking.Client.CreateLobby(type, mode, slots, callback);
        /// <summary>
        ...
        {
            API.Matchmaking.Client.CreateLobby(ELobbyType.k_ELobbyTypeInvisible, SteamLobbyModeType.Party, slots, (r,l,e) =>
            {
        ...
        {
            API.Matchmaking.Client.CreateLobby(type, SteamLobbyModeType.Session, slots, (r, l, e) =>
            {
                if (!e && r == EResult.k_EResultOK)
        ...
        {
            API.Matchmaking.Client.CreateLobby(ELobbyType.k_ELobbyTypePublic, SteamLobbyModeType.Session, slots, (r, l, e) =>
            {
                if (!e && r == EResult.k_EResultOK)
                    l.Mode = SteamLobbyModeType.Session;
        ...
        {
            API.Matchmaking.Client.CreateLobby(ELobbyType.k_ELobbyTypePrivate, SteamLobbyModeType.Session, slots, (r, l, e) =>
            {
                if (!e && r == EResult.k_EResultOK)
                    l.Mode = SteamLobbyModeType.Session;
        ...
        {
            API.Matchmaking.Client.CreateLobby(ELobbyType.k_ELobbyTypeFriendsOnly, SteamLobbyModeType.Session, slots, (r, l, e) =>
            {
                if (!e && r == EResult.k_EResultOK)
                    l.Mode = SteamLobbyModeType.Session;
        ...
        {
            API.Matchmaking.Client.SetLobbyData(id, key, value);
        }
        /// <summary>
        ...
        public static List<LobbyData> MemberOfLobbies => API.Matchmaking.Client.memberOfLobbies;
        /// <summary>
        ...
        {
            lobby = API.Matchmaking.Client.memberOfLobbies.FirstOrDefault(p => p.IsParty);
