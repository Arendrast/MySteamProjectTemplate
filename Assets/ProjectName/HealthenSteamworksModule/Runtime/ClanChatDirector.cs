...
namespace Heathen.SteamworksIntegration.UI
{
    ...
    public class ClanChatDirector : MonoBehaviour
    {
        ...
        {
            API.Clans.Client.OnChatMessageReceived.AddListener(HandleNewMessage);
            API.Clans.Client.OnGameConnectedChatJoin.AddListener(HandleJoined);
            API.Clans.Client.OnGameConnectedChatLeave.AddListener(HandleLeave);
        }

        private void OnDisable()
        {
            API.Clans.Client.OnChatMessageReceived.RemoveListener(HandleNewMessage);
            API.Clans.Client.OnGameConnectedChatJoin.RemoveListener(HandleJoined);
            API.Clans.Client.OnGameConnectedChatLeave.RemoveListener(HandleLeave);
        }
