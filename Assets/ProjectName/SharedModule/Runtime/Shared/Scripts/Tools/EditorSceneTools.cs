...
namespace ProjectName.SharedModule.Runtime.Shared.Scripts.Tools
{
    public static class EditorSceneTools
    {
        ...
        public static void LoadSceneLvl1Zone1() =>
            OpenScene("Assets/CrazySWAT/CoreModule/Runtime/Shared/Scenes/Initial.unity");

        [MenuItem("Scenes/Load Metrics #2")]
        public static void OpenMetricsScene() =>
            OpenScene("Assets/CrazySWAT/LevelModule/Runtime/Shared/Prefabs/Levels/Metrics/Metrics.unity");
        ...
        private static void OpenLvlZone(int levelNumber, int zoneNumber) => OpenScene(
            $"Assets/CrazySWAT/LevelModule/Runtime/Shared/Prefabs/Levels/{levelNumber}/Zone{zoneNumber}/Lvl{levelNumber}_{zoneNumber}.unity");
