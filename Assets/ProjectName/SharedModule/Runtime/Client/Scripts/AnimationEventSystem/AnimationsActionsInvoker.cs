...
using ProjectName.SharedModule.Runtime.Client.Scripts.Animator;
using UnityEngine;

namespace ProjectName.SharedModule.Runtime.Client.Scripts.AnimationEventSystem
{
    public class AnimationsActionsInvoker
    {
        private readonly IReadOnlyList<AnimationActionInfo> _animationActionsInfo;
        private readonly int _targetAnimationHash;

        public AnimationsActionsInvoker(AnimatorStateObserver animatorStateObserver,
            IReadOnlyList<AnimationActionInfo> animationActionsInfo, int targetAnimationHash)
        {
