...
{
    public static class SlicedFilledImageTools
    {
        public static void SubscribeToSetFillAmountBySliderValue(this SlicedFilledImage slicedFilledImage, Slider slider)
        {
            slider.onValueChanged.AddListener(value => slicedFilledImage.fillAmount = value / slider.maxValue);
        }
    }
