...
namespace ProjectName.CoreModule.Runtime.Shared.Scripts.GameStateMachinePart
{
    public class GameStateMachine
    {
        ...
        public GameStateMachine(BootstrapGameState bootstrapGameState, 
            ClientMainMenuGameState clientMainMenuGameState, MatchGameState matchGameState, HardResetGameState hardResetGameState)
        {
            ...
            RegisterState(hardResetGameState, GameStateType.HardReset);
