...
using ProjectName.HudModule.Runtime.Scripts.HudPopup;
...
namespace ProjectName.CoreModule.Runtime.Shared.Scripts.Infrastructure
{
    public class MatchSharedGameSubState : IMatchSharedService, IDisposable
    {
        ...
        public MatchSharedGameSubState(OperatorFactory operatorFactory,
            ...
            ProjectInputActions inputActions, NetworkTimerService networkTimerService, ClientManager clientManager,
