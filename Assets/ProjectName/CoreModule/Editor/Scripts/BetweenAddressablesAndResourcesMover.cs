...
namespace ProjectName.CoreModule.Editor.Scripts
{
    public class BetweenAddressablesAndResourcesMover : EditorWindow
    {
        ...
        [MenuItem("Tools/Core Module/Settings")]
        public static void ShowWindow()
        {
            GetWindow<BetweenAddressablesAndResourcesMover>("Core Module Settings");
        }
        ...
        private void OnGUI()
        {
            GUILayout.Label("Core Module Settings", EditorStyles.boldLabel);

            GUILayout.Space(20);

            GUILayout.BeginVertical();

            if (GUILayout.Button("Remove define and move addressable assets to resources", GetButtonStyle()))
            {
            ...
            if (GUILayout.Button("Add define and move resources assets to addressable", GetButtonStyle()))
            {
        ...
        public static void RemoveDefineAndMoveAddressablesAssetsToResources()
        {
            ...
            Debug.Log(
                "Resources assets moved from Assets/MainHub/Modules to Assets/Resources and removed from addressables");
        }
        ...
        public static void AddDefineAndMoveFilesResourcesFilesToAddressables()
        {
            ...
            MoveResourcesAssetsToAddressables(ResourcesPath, "*Module", ModulesPath);

            AssetDatabase.SaveAssets();
            AssetDatabase.Refresh();

            Debug.Log(
                "Addressable assets moved from Assets/Resources to Assets/MainHub/Modules and added to addressables");
        }
