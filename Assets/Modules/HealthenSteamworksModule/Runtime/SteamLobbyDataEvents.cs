...
namespace Heathen.SteamworksIntegration.Modules.HealthenSteamworksModule.Runtime
{
    ...
    public class SteamLobbyDataEvents : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            Matchmaking.Client.OnLobbyInvite.AddListener(onLobbyInvite.Invoke);
            Overlay.Client.OnGameLobbyJoinRequested.AddListener(onLobbyJoinRequest.Invoke);
        }
        ...
        private void OnDestroy()
        {
            ...
            Matchmaking.Client.OnLobbyInvite.RemoveListener(onLobbyInvite.Invoke);
            Overlay.Client.OnGameLobbyJoinRequested.RemoveListener(onLobbyJoinRequest.Invoke);
        }
