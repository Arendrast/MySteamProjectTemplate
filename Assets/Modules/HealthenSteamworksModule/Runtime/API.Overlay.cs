...
namespace Heathen.SteamworksIntegration.Modules.HealthenSteamworksModule.Runtime
{
    public static class Overlay
    {
        public static class Client
        {
            ...
            static void Init()
            {
                m_OnGameOverlayActivated = new GameOverlayActivatedEvent();
                m_OnGameServerChangeRequested = new GameServerChangeRequestedEvent();
                m_OnGameLobbyJoinRequested = new GameLobbyJoinRequestedEvent();
                m_OnGameRichPresenceJoinRequest = new GameRichPresenceJoinRequestedEvent();
            ...
            public static bool IsShowing => m_IsShowing;
            public static ENotificationPosition NotificationPosition
            {
                ...
                set
                {
                    ...
                    SteamUtils.SetOverlayNotificationPosition(m_NotificationPosition);
                }
            }
            public static Vector2Int NotificationInset
            {
                get => m_NotificationInset;
                set
                {
                    m_NotificationInset = value;
            ...
            /// </summary>
            public static GameOverlayActivatedEvent OnGameOverlayActivated
            {
                get
                {
                    if (m_GameOverlayActivated_t == null)
                       ...
                       {
                           m_IsShowing = r.m_bActive == 1;
                           m_OnGameOverlayActivated.Invoke(m_IsShowing);
                       });

                    return m_OnGameOverlayActivated;
                }
            }
            /// <summary>
            ...
            /// </summary>
            public static GameServerChangeRequestedEvent OnGameServerChangeRequested
            {
                get
                {
                    if (m_GameServerChangeRequested_t == null)
                        m_GameServerChangeRequested_t = Callback<GameServerChangeRequested_t>.Create((r) => m_OnGameServerChangeRequested.Invoke(r.m_rgchServer, r.m_rgchPassword));

                    return m_OnGameServerChangeRequested;
                }
            }
            /// <summary>
            ...
            /// </summary>
            public static GameLobbyJoinRequestedEvent OnGameLobbyJoinRequested
            {
                get
                {
                    if (m_GameLobbyJoinRequested_t == null)
                        m_GameLobbyJoinRequested_t = Callback<GameLobbyJoinRequested_t>.Create((r) => m_OnGameLobbyJoinRequested.Invoke(r.m_steamIDLobby, r.m_steamIDFriend));

                    return m_OnGameLobbyJoinRequested;
                }
            }
            /// <summary>
            /// Invoked when the SteamAPI responds with a GameRichPresenceJoinRequested_t
            /// </summary>
            public static GameRichPresenceJoinRequestedEvent OnGameRichPresenceJoinRequested
            {
                get
                {
                    if (m_GameRichPresenceJoinRequested_t == null)
                        m_GameRichPresenceJoinRequested_t = Callback<GameRichPresenceJoinRequested_t>.Create((r) => m_OnGameRichPresenceJoinRequest.Invoke(r.m_steamIDFriend, r.m_rgchConnect));

                    return m_OnGameRichPresenceJoinRequest;
                }
            }

            private static bool m_IsShowing = false;
            private static ENotificationPosition m_NotificationPosition = ENotificationPosition.k_EPositionBottomRight;
            private static Vector2Int m_NotificationInset = Vector2Int.zero;

            private static GameOverlayActivatedEvent m_OnGameOverlayActivated = new GameOverlayActivatedEvent();
            private static GameServerChangeRequestedEvent m_OnGameServerChangeRequested = new GameServerChangeRequestedEvent();
            private static GameLobbyJoinRequestedEvent m_OnGameLobbyJoinRequested = new GameLobbyJoinRequestedEvent();
            private static GameRichPresenceJoinRequestedEvent m_OnGameRichPresenceJoinRequest = new GameRichPresenceJoinRequestedEvent();
