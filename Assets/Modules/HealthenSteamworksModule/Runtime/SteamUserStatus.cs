...
namespace Heathen.SteamworksIntegration.Modules.HealthenSteamworksModule.Runtime
{
    ...
    public class SteamUserStatus : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            Friends.Client.OnFriendRichPresenceUpdate.AddListener(InternalRichPresenceUpdate);
        }

        private void OnDestroy()
        {
            m_Data.onChanged.RemoveListener(InternalPersonaStateChange);
            Friends.Client.OnFriendRichPresenceUpdate.RemoveListener(InternalRichPresenceUpdate);
        }
