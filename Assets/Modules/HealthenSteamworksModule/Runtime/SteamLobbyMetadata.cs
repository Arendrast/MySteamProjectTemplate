...
namespace Heathen.SteamworksIntegration.Modules.HealthenSteamworksModule.Runtime
{
    ...
    public class SteamLobbyMetadata : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            Matchmaking.Client.OnLobbyDataUpdate.AddListener(HandleMetadataChange);
            RefreshKeyValues();
        }
        ...
        public void Set()
        {
                ...
                && m_Inspector.Data.IsOwner)
            {
                ...
                {
                    Matchmaking.Client.SetLobbyData(m_Inspector.Data, kvp.key, kvp.value);
                }
            }
        }
        ...
        public void Set(string key, string value)
        {
            if (m_Inspector.Data.IsValid)
            {
                if (m_Inspector.Data.IsOwner)
                    Matchmaking.Client.SetLobbyData(m_Inspector.Data, key, value);
                else
