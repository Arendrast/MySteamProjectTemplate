...
namespace Heathen.SteamworksIntegration.Modules.HealthenSteamworksModule.Runtime
{
    ...
    public class SteamInventoryExchange : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            Inventory.Client.OnSteamInventoryResultReady.AddListener(HandleInventoryUpdated);

            Interface.WhenReady(RefreshCanExchange);
        }

        private void OnDestroy()
        {
            Inventory.Client.OnSteamInventoryResultReady.RemoveListener(HandleInventoryUpdated);
        }
