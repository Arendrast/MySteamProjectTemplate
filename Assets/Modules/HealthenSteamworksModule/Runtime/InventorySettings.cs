...
namespace Heathen.SteamworksIntegration.Modules.HealthenSteamworksModule.Runtime
{
    ...
    public class InventorySettings
    {
        ...
        public void UpdateItemDefinitions(bool debugLog)
        {
            ...
            if (Inventory.Client.GetItemDefinitionIDs(out SteamItemDef_t[] results))
            {
                if (debugLog)
                ...
                for (int i = 0; i < results.Length; i++)
                {
                    ...
                    try
                    {
                        ...
                        var type = Inventory.Client.GetItemDefinitionProperty(itemDefId, "type");
                        switch (type)
                        {
                            case "item":
                        ...
                        target.item_drop_start_time = Inventory.Client.GetItemDefinitionProperty(itemDefId, "drop_start_time");

                        var excahnge = Inventory.Client.GetItemDefinitionProperty(itemDefId, "exchange");
                        ...
                        var bgColor = Inventory.Client.GetItemDefinitionProperty(itemDefId, "background_color");
                        ...
                        var nColor = Inventory.Client.GetItemDefinitionProperty(itemDefId, "name_color");
                        ...
                        target.item_icon_url = Inventory.Client.GetItemDefinitionProperty(itemDefId, "icon_url");
                        target.item_icon_url_large = Inventory.Client.GetItemDefinitionProperty(itemDefId, "icon_url_large");

                        var returnString = Inventory.Client.GetItemDefinitionProperty(itemDefId, "marketable");
                        if (!string.IsNullOrEmpty(returnString) && bool.TryParse(returnString, out bool marketable))
                            target.item_marketable = marketable;

                        returnString = Inventory.Client.GetItemDefinitionProperty(itemDefId, "tradable");
                        if (!string.IsNullOrEmpty(returnString) && bool.TryParse(returnString, out bool tradable))
                            target.item_tradable = tradable;

                        returnString = Inventory.Client.GetItemDefinitionProperty(itemDefId, "tag_generators");
                        if (!string.IsNullOrEmpty(returnString))
                            generators.Add(target, returnString);

                        returnString = Inventory.Client.GetItemDefinitionProperty(itemDefId, "store_hidden");
                        ...
                        returnString = Inventory.Client.GetItemDefinitionProperty(itemDefId, "use_drop_limit");
                        ...
                        returnString = Inventory.Client.GetItemDefinitionProperty(itemDefId, "use_drop_window");
                        ...
                        returnString = Inventory.Client.GetItemDefinitionProperty(itemDefId, "granted_manually");
                        ...
                        returnString = Inventory.Client.GetItemDefinitionProperty(itemDefId, "use_bundle_price");
                        ...
                        returnString = Inventory.Client.GetItemDefinitionProperty(itemDefId, "auto_stack");
                        ...
                        target.item_tag_generator_name = Inventory.Client.GetItemDefinitionProperty(itemDefId, "tag_generator_name");
                        target.item_tag_generator_values.Populate(itemDefId);
                        target.item_tags.Populate(itemDefId);

                        target.item_store_tags = new List<string>(Inventory.Client.GetItemDefinitionProperty(itemDefId, "store_tags").Split(';'));
                        target.item_store_images = new List<string>(Inventory.Client.GetItemDefinitionProperty(itemDefId, "store_images").Split(';'));

                        returnString = Inventory.Client.GetItemDefinitionProperty(itemDefId, "tradabitem_drop_limitle");
                        ...
                        returnString = Inventory.Client.GetItemDefinitionProperty(itemDefId, "item_drop_interval");
                        ...
                        returnString = Inventory.Client.GetItemDefinitionProperty(itemDefId, "item_drop_window");
                        ...
                        returnString = Inventory.Client.GetItemDefinitionProperty(itemDefId, "item_drop_max_per_window");
                ...
                for (int i = 0; i < bundles.Count; i++)
                {
                    try
                    {
                        ...
                        var bundleData = Inventory.Client.GetItemDefinitionProperty(target.Id, "bundle");
...
#pragma warning restore UNT0008 // Null propagation on Unity objects
        ...
        public void HandleSettingsInventoryDefinitionUpdate()
        {
            ...
            Inventory.Client.OnSteamInventoryDefinitionUpdate.RemoveListener(HandleSettingsInventoryDefinitionUpdate);
        }
#endif
