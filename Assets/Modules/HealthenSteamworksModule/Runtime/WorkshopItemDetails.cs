...
namespace Heathen.SteamworksIntegration.Modules.HealthenSteamworksModule.Runtime
{
    ...
    public class WorkshopItemDetails
    {
        ...
        public float DownloadCompletion
        {
            get
            {
                UserGeneratedContent.Client.GetItemDownloadInfo(FileId, out float value);
                return value;
            }
        }
        /// <summary>
        ...
        public DirectoryInfo FolderPath
        {
            get
            {
                UserGeneratedContent.Client.GetItemInstallInfo(FileId, out ulong _, out string path, out DateTime _);
        ...
        /// <param name="callback">Will respond when the query completes with the file in question</param>
        ...
        {
            var handle = UserGeneratedContent.Client.StartItemUpdate(ConsumerApp, FileId);
        ...
        public bool GetPreviewImage(Action<string, byte[]> callback)
        {
            ...
            {
                UserGeneratedContent.Client.GetUgcImage(itemDetails.m_hPreviewFile, callback);
                return true;
            }
            else
                return false;
        ...
        public void DeleteItem(Action<DeleteItemResult_t, bool> callback) => UserGeneratedContent.Client.DeleteItem(FileId, callback);
        /// <summary>
        /// Request download of this item
        /// </summary>
        /// <param name="highPriority"></param>
        /// <returns></returns>
        public bool DownloadItem(bool highPriority) => UserGeneratedContent.Client.DownloadItem(FileId, highPriority);
        /// <summary>
        /// Subscribe to the item
        /// </summary>
        /// <param name="callback"></param>
        public void Subscribe(Action<RemoteStorageSubscribePublishedFileResult_t, bool> callback) => UserGeneratedContent.Client.SubscribeItem(FileId, callback);
        /// <summary>
        /// Unsubscribe to the item
        /// </summary>
        /// <param name="callback"></param>
        public void Unsubscribe(Action<RemoteStorageUnsubscribePublishedFileResult_t, bool> callback) => UserGeneratedContent.Client.UnsubscribeItem(FileId, callback);
        /// <summary>
        /// Set the user's vote for this item
        /// </summary>
        /// <param name="voteUp"></param>
        /// <param name="callback"></param>
        public void SetVote(bool voteUp, Action<SetUserItemVoteResult_t, bool> callback) => UserGeneratedContent.Client.SetUserItemVote(FileId, voteUp, callback);
        /// <summary>
        ...
        public void StartPlayTime(Action<StartPlaytimeTrackingResult_t, bool> callback) => UserGeneratedContent.Client.StartPlaytimeTracking(new PublishedFileId_t[] { FileId }, callback);
        /// <summary>
        /// Stop playtime tracking
        /// </summary>
        /// <param name="callback">A delegate of the form (<see cref="StartPlaytimeTrackingResult_t"/> result, <see cref="bool"/> ioError) that will be invoked when the request is complete</param>
        public void StopPlayTime(Action<StopPlaytimeTrackingResult_t, bool> callback) => UserGeneratedContent.Client.StopPlaytimeTracking(new PublishedFileId_t[] { FileId }, callback);
    }
}
#endif