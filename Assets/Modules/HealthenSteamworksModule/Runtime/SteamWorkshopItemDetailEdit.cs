...
namespace Heathen.SteamworksIntegration.Modules.HealthenSteamworksModule.Runtime
{
    ...
    public class SteamWorkshopItemDetailEdit : MonoBehaviour
    {
        ...
        public void UpdateAll()
        {
            ...
            var handle = UserGeneratedContent.Client.StartItemUpdate(m_Inspector.Data.ConsumerApp, m_Inspector.Data.FileId);
            ...
            UserGeneratedContent.Client.SubmitItemUpdate(handle, GetChangeNote(), HandleEditResult);
