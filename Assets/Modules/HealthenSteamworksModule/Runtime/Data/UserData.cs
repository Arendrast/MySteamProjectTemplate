...
namespace Heathen.SteamworksIntegration.Modules.HealthenSteamworksModule.Runtime.Data
{
    ...
    public struct UserData : IEquatable<CSteamID>, IEquatable<ulong>, IEquatable<UserData>
    {
        ...
        /// <returns></returns>
        public readonly bool GetGamePlayed(out FriendGameInfo gameInfo) => Friends.Client.GetFriendGamePlayed(id, out gameInfo);
        /// <summary>
        ...
        /// </summary>
        /// <param name="user"></param>
        public static void AddFriend(AccountID_t user) => Overlay.Client.Activate(FriendDialog.friendadd, UserData.Get(user));
        /// <summary>
        ...
        /// </summary>
        /// <param name="user"></param>
        public static void RemoveFriend(AccountID_t user) => Overlay.Client.Activate(FriendDialog.friendremove, UserData.Get(user));
    #region Boilerplate
