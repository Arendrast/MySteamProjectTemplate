...
namespace Heathen.SteamworksIntegration.Modules.HealthenSteamworksModule.Runtime.Data
{
    ...
    public struct ClanData : IEquatable<CSteamID>, IEquatable<ClanData>, IEquatable<ulong>, IComparable<CSteamID>, IComparable<ClanData>, IComparable<ulong>
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static ClanData[] Get() => Clans.Client.GetClans();
        /// <summary>
        ...
        public readonly void JoinChat(Action<ChatRoom, bool> callback) => Clans.Client.JoinChatRoom(id, callback);
        /// <summary>
        /// Request the system to locate and load the clan's icon
        /// </summary>
        /// <param name="callback"></param>
        public readonly void LoadIcon(Action<Texture2D> callback) => Friends.Client.GetFriendAvatar(SteamId, callback);
