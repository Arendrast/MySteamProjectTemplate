...
namespace Heathen.SteamworksIntegration.Modules.HealthenSteamworksModule.Runtime.Data
{
    ...
    public struct InputControllerStateData
    {
        ...
        /// <returns>The <see cref="InputActionStateData"/> representing the current state of the action</returns>
        public InputActionStateData GetActionData(InputActionData action) => GetActionData(action.Name);
        /// <summary>
        /// Gets the action data of a specific input action
        /// </summary>
