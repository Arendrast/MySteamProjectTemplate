...
namespace Heathen.SteamworksIntegration.Modules.HealthenSteamworksModule.Runtime.Data
{
    ...
    public struct AppData : IEquatable<AppId_t>, IEquatable<CGameID>, IEquatable<uint>, IEquatable<ulong>, IEquatable<AppData>, IComparable<AppData>, IComparable<AppId_t>, IComparable<uint>, IComparable<ulong>
    {
        ...
        public readonly string Name
        {
            get
            {
                App.Web.GetAppName(AppId, out string value);
                return value;
            }
        }
        /// <summary>
        ...
        public readonly bool GetName(out string name) => App.Web.GetAppName(AppId, out name);
        /// <summary>
        ...
        public readonly void GetName(Action<string, bool> callback) => App.Web.GetAppName(AppId, callback);
        /// <summary>
        ...
        public static void LoadNames(Action callback) => App.Web.LoadAppNames(callback);
        /// <summary>
