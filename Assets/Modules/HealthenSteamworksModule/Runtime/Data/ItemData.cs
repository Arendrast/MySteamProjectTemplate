...
namespace Heathen.SteamworksIntegration.Modules.HealthenSteamworksModule.Runtime.Data
{
    ...
    public struct ItemData : IEquatable<ItemData>, IEquatable<int>, IEquatable<SteamItemDef_t>, IComparable<ItemData>, IComparable<int>, IComparable<SteamItemDef_t>
    {
        ...
        /// </summary>
        public readonly bool HasPrice => Inventory.Client.GetItemPrice(new SteamItemDef_t(id), out ulong _, out ulong _);
        /// <summary>
        ...
        public readonly ulong CurrentPrice
        {
            get
            {
                if (Inventory.Client.GetItemPrice(new SteamItemDef_t(id), out ulong current, out ulong _))
                {
                    return current;
                }
                else
        ...
        public readonly ulong BasePrice
        {
            get
            {
                if (Inventory.Client.GetItemPrice(new SteamItemDef_t(id), out ulong _, out ulong baseprice))
                {
                    return baseprice;
                }
                else
        ...
        /// </summary>
        /// <returns></returns>
        public readonly List<ItemDetail> GetDetails() => Inventory.Client.Details(this);
        /// <summary>
        /// Get the total quantity of this item owned by the user
        /// <para>This is simply the sum of all <see cref="ItemData"/></para>
        /// </summary>
        /// <returns></returns>
        public readonly long GetTotalQuantity() => Inventory.Client.ItemTotalQuantity(this);
        /// <summary>
        ...
        /// <returns></returns>
        public readonly bool AddPromoItem(Action<InventoryResult> callback) => Inventory.Client.AddPromoItem(new SteamItemDef_t(id), callback);
        /// <summary>
        ...
        public readonly bool Consume(Action<InventoryResult> callback)
        {
            ...
            Inventory.Client.ConsumeItem(instance.itemDetails.m_itemId, 1, callback);
            return true;
        }
        /// <summary>
        ...
        /// <param name="callback">A delegate of the form (<see cref="InventoryResult"/> results) that is invoked when the process completes</param>
        public readonly void Consume(ConsumeOrder order, Action<InventoryResult> callback) => Inventory.Client.ConsumeItem(order.detail.m_itemId, order.quantity, callback);
        /// <summary>
            ...
            else
            {
                ...
                worker.DoWork += (sender, eventArgs) =>
                {
                    foreach(var order in orders)
                    {
                        ...
                        Inventory.Client.ConsumeItem(order.detail.m_itemId, order.quantity, (r) =>
                        {
                            eResult = r.result;
        ...
        public readonly void Exchange(IEnumerable<ExchangeEntry> recipeEntries, Action<InventoryResult> callback)
        {
            ...
            Inventory.Client.ExchangeItems(new SteamItemDef_t(id), instances, counts, callback);
        }
        /// <summary>
        ...
        {
            Inventory.Client.GenerateItems(new SteamItemDef_t[] { new SteamItemDef_t(id) }, new uint[] { 1 }, callback);
        }
        /// <summary>
        /// This is only available to developers of this app and should only be used prior to launch of the game for testing purposes.
        /// </summary>
        ...
        {
            Inventory.Client.GenerateItems(new SteamItemDef_t[] { new SteamItemDef_t(id) }, new uint[] { quantity }, callback);
        }
        /// <summary>
        /// Starts the purchase process
        /// <para>Assuming the item has a valid price configured this will open the Steam overlay with this item in the shopping cart. The <see cref="SteamInventoryStartPurchaseResult_t"/> provided in the callback will indicate the transaction ID which can be used with <see cref="Inventory.Client.OnSteamMicroTransactionAuthorizationResponse"/> to know the purchase is completed if it is completed.</para>
        ...
        {
            Inventory.Client.StartPurchase(new SteamItemDef_t[] { new SteamItemDef_t(id) }, new uint[] { 1 }, callback);
        }
        /// <summary>
        /// Starts the purchase process
        /// <para>Assuming the item has a valid price configured this will open the Steam overlay with this item in the shopping cart. The <see cref="SteamInventoryStartPurchaseResult_t"/> provided in the callback will indicate the transaction ID which can be used with <see cref="Inventory.Client.OnSteamMicroTransactionAuthorizationResponse"/> to know the purchase is completed if it is completed.</para>
        ...
        {
            Inventory.Client.StartPurchase(new SteamItemDef_t[] { new SteamItemDef_t(id) }, new uint[] { count }, callback);
        }
        /// <summary>
        ...
        public readonly bool GetPrice(out ulong currentPrice, out ulong basePrice) => Inventory.Client.GetItemPrice(new SteamItemDef_t(id), out currentPrice, out basePrice);
        /// <summary>
        ...
        /// </summary>
        /// <param name="callback">A delegate of the form (<see cref="InventoryResult"/> results) that is invoked when the process completes</param>
        public readonly void TriggerDrop(Action<InventoryResult> callback) => Inventory.Client.TriggerItemDrop(new SteamItemDef_t(id), callback);
        /// <summary>
        ...
        public static void RequestPrices(Action<SteamInventoryRequestPricesResult_t, bool> callback) => Inventory.Client.RequestPrices(callback);
        /// <summary>
        /// Request all items be updated in local memory
        /// </summary>
        /// <param name="callback">A delegate of the form (<see cref="InventoryResult"/> results) that is invoked when the process completes</param>
        public static void Update(Action<InventoryResult> callback) => Inventory.Client.GetAllItems(callback);
        /// <summary>
