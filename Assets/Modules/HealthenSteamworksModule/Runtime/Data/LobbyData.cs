...
namespace Heathen.SteamworksIntegration.Modules.HealthenSteamworksModule.Runtime.Data
{
    ...
    public struct LobbyData : IEquatable<CSteamID>, IEquatable<ulong>, IEquatable<LobbyData>
    {
        ...
        {
            get => new LobbyMemberData { lobby = this, user = Matchmaking.Client.GetLobbyOwner(id) };
            set => Matchmaking.Client.SetLobbyOwner(id, value.user);
        }
        /// <summary>
        ...
        /// </summary>
        public readonly bool IsTypeSet => !string.IsNullOrEmpty(Matchmaking.Client.GetLobbyData(id, DataType));
        /// <summary>
        ...
        public readonly ELobbyType Type
        {
            get
            {
                if (int.TryParse(Matchmaking.Client.GetLobbyData(id, DataType), out int enumVal))
                {
            ...
            set => Matchmaking.Client.SetLobbyType(id, value);
        }
        /// <summary>
        ...
        /// </summary>
        public readonly bool IsParty
        {
            get
            {
                return Mode == SteamLobbyModeType.Party;
            }
        }
        ...
        public readonly bool IsSession
        {
            get
            {
                return Mode == SteamLobbyModeType.Session;
            }
        }
        public readonly bool IsGeneral
        {
            get
            {
                return Mode == SteamLobbyModeType.General;
            }
        }
        /// <summary>
        ...
        {
            get => Matchmaking.Client.GetLobbyMemberData(id, User.Client.Id, DataReady) == "true";
            set => Matchmaking.Client.SetLobbyMemberData(id, DataReady, value.ToString().ToLower());
        }
        /// <summary>
        /// Is the lobby full e.g. the number of members is equal to or greater than the number of slots listed for the lobby
        /// </summary>
        public readonly bool Full => IsValid && Matchmaking.Client.GetLobbyMemberLimit(id) <= SteamMatchmaking.GetNumLobbyMembers(this);
        /// <summary>
        /// The max number of members this lobby can take
        /// </summary>
        public readonly int MaxMembers
        {
            get => Matchmaking.Client.GetLobbyMemberLimit(id);
            set => Matchmaking.Client.SetLobbyMemberLimit(id, value);
        }
        /// <summary>
        ...
        public readonly bool GetMember(UserData user, out LobbyMemberData member) => Matchmaking.Client.GetMember(this, user, out member);
        /// <summary>
        ...
        /// <returns></returns>
        public readonly bool SetType(ELobbyType type) => Matchmaking.Client.SetLobbyType(id, type);
        /// <summary>
        /// Mark the lobby as joinable or not
        /// </summary>
        /// <param name="makeJoinable"></param>
        /// <returns></returns>
        public readonly bool SetJoinable(bool makeJoinable) => Matchmaking.Client.SetLobbyJoinable(id, makeJoinable);
        /// <summary>
        ...
        public static void Create(ELobbyType type, SteamLobbyModeType mode, int slots, Action<EResult, LobbyData, bool> callback) => Matchmaking.Client.CreateLobby(type, mode, slots, callback);
        /// <summary>
        ...
        {
            Matchmaking.Client.CreateLobby(ELobbyType.k_ELobbyTypeInvisible, SteamLobbyModeType.Party, slots, (r,l,e) =>
            {
        ...
        {
            Matchmaking.Client.CreateLobby(ELobbyType.k_ELobbyTypePublic, SteamLobbyModeType.Session, slots, (r, l, e) =>
            {
                if (!e && r == EResult.k_EResultOK)
                    l.Mode = SteamLobbyModeType.Session;
        ...
        {
            Matchmaking.Client.CreateLobby(ELobbyType.k_ELobbyTypePrivate, SteamLobbyModeType.Session, slots, (r, l, e) =>
            {
                if (!e && r == EResult.k_EResultOK)
                    l.Mode = SteamLobbyModeType.Session;
        ...
        {
            Matchmaking.Client.CreateLobby(ELobbyType.k_ELobbyTypeFriendsOnly, SteamLobbyModeType.Session, slots, (r, l, e) =>
            {
                if (!e && r == EResult.k_EResultOK)
                    l.Mode = SteamLobbyModeType.Session;
        ...
        public readonly bool DeleteLobbyData(string dataKey) => Matchmaking.Client.DeleteLobbyData(id, dataKey);
        /// <summary>
        ...
        public readonly bool InviteUserToLobby(UserData targetUser) => Matchmaking.Client.InviteUserToLobby(id, targetUser);
        /// <summary>
        ...
        {
            Matchmaking.Client.SetLobbyGameServer(id, 0, 0, gameServerId);
        }
        /// <summary>
        /// <para>
        ...
        {
            Matchmaking.Client.SetLobbyGameServer(id, 0, 0, User.Client.Id);
        }
        /// <summary>
        ...
        public readonly bool KickMember(UserData memberId)
        {
            ...
            var kickList = Matchmaking.Client.GetLobbyData(id, DataKick);
            ...
            return Matchmaking.Client.SetLobbyData(id, DataKick, kickList);
        }
        /// <summary>
        ...
        public readonly bool ClearKickList()
        {
            ...
            return Matchmaking.Client.DeleteLobbyData(id, DataKick);
        }
        /// <summary>
        ...
        {
            var list = Matchmaking.Client.GetLobbyData(id, DataKick);
        ...
        /// <summary>
        /// Sets metadata on the lobby, this can only be called by the lobby owner
        /// </summary>
        /// <param name="key">The key of the metadata to set</param>
        /// <param name="value">The value of the metadata to set</param>
        public readonly void SetLobbyMetadata(string key, string value)
        {
            Matchmaking.Client.SetLobbyData(id, key, value);
        }
        /// <summary>
        ...
        public readonly bool RequestData() => Matchmaking.Client.RequestLobbyData(id);
        ...
        public static void Join(string accountId, Action<LobbyEnter, bool> callback) => Matchmaking.Client.JoinLobby(Get(accountId), callback);
        /// <summary>
        /// Join the lobby
        /// </summary>
        /// <param name="lobby">The lobby to join</param>
        /// <param name="callback">Invoked when the process is complete, handler(LobbyEnter_t result, bool IOError)</param>
        public static void Join(LobbyData lobby, Action<LobbyEnter, bool> callback) => Matchmaking.Client.JoinLobby(lobby, callback);
        /// <summary>
        /// Join the lobby represented by this account Id
        /// </summary>
        /// <param name="accountId">Must be a valid uint as a string</param>
        /// <param name="callback">Invoked when the process is complete, handler(LobbyEnter_t result, bool IOError)</param>
        public static void Join(AccountID_t accountId, Action<LobbyEnter, bool> callback) => Matchmaking.Client.JoinLobby(Get(accountId), callback);
        /// <summary>
        ...
        /// <summary>
        /// Heathen standard metadata field indicating that a session lobby has been identified, this is only used with Party Lobbies
        /// </summary>
