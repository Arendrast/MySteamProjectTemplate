...
namespace Heathen.SteamworksIntegration.Modules.HealthenSteamworksModule.Runtime.Data
{
    ...
    public struct LeaderboardData : IEquatable<SteamLeaderboard_t>, IEquatable<ulong>, IEquatable<string>
    {
        ...
        {
            Leaderboards.Client.DownloadEntries(id, new CSteamID[] { UserData.Me }, maxDetailEntries, (results, error) =>
            {
        ...
        /// <param name="callback">The delegate to invoke when the process is complete</param>
        public readonly void GetEntries(ELeaderboardDataRequest request, int start, int end, int maxDetailEntries, Action<LeaderboardEntry[], bool> callback) => Leaderboards.Client.DownloadEntries(id, request, start, end, maxDetailEntries, callback);
        /// <summary>
        /// Invokes the callback with the query results 
        /// </summary>
        /// <param name="users">The users to get results for</param>
        /// <param name="callback">The delegate to invoke when the process is complete</param>
        public readonly void GetEntries(UserData[] users, int maxDetailEntries, Action<LeaderboardEntry[], bool> callback) => Leaderboards.Client.DownloadEntries(id, Array.ConvertAll<UserData, CSteamID>(users, p => p.id), maxDetailEntries, callback);
        /// <summary>
        ...
        /// <param name="users">The users to get results for</param>
        /// <param name="callback">The delegate to invoke when the process is complete</param>
        public readonly void GetEntries(CSteamID[] users, int maxDetailEntries, Action<LeaderboardEntry[], bool> callback) => Leaderboards.Client.DownloadEntries(id, users, maxDetailEntries, callback);
        /// <summary>
        ...
        public static void Get(string name, Action<LeaderboardData, bool> callback) => Leaderboards.Client.Find(name, callback);
        /// <summary>
        ...
        public static void GetOrCreate(string name, ELeaderboardDisplayType displayType, ELeaderboardSortMethod sortMethod, Action<LeaderboardData, bool> callback) => Leaderboards.Client.FindOrCreate(name, sortMethod, displayType, callback);
        /// <summary>
        ...
        public readonly void UploadScore(int score, ELeaderboardUploadScoreMethod method, Action<LeaderboardScoreUploaded, bool> callback = null) => Leaderboards.Client.UploadScore(id, method, score, null, callback);
        ...
        /// <param name="method"></param>
        /// <param name="callback">A delegate of the form (<see cref="LeaderboardScoreUploaded"/> results, <see cref="bool"/> ioError) that will be invoked when the process is completed</param>
        public readonly void UploadScore(int score, int[] scoreDetails, ELeaderboardUploadScoreMethod method, Action<LeaderboardScoreUploaded, bool> callback = null) => Leaderboards.Client.UploadScore(id, method, score, scoreDetails, callback);
        ...
        public readonly void AttachUGC(string fileName, object jsonObject, System.Text.Encoding encoding, Action<LeaderboardUGCSet, bool> callback = null) => Leaderboards.Client.AttachUGC(id, fileName, jsonObject, encoding, callback);
        /// <summary>
        /// Attempts to save, share and attach an object to the leaderboard
        /// </summary>
        /// <remarks>
        ...
        /// <param name="jsonObject">A JsonUtility serializable object, we will serialize this to UTF8 format and then convert to byte[] for you and upload to Steam Remote Storage</param>
        /// <param name="callback">A delegate of the form (<see cref="LeaderboardUGCSet"/> results, <see cref="bool"/> ioError) that will be invoked when the process is completed</param>
        public readonly void AttachUGC(string fileName, object jsonObject, Action<LeaderboardUGCSet, bool> callback = null) => Leaderboards.Client.AttachUGC(id, fileName, jsonObject, System.Text.Encoding.UTF8, callback);
        /// <summary>
        ...
        public static implicit operator LeaderboardData(ulong id) => new LeaderboardData { id = new SteamLeaderboard_t(id), apiName = Leaderboards.Client.GetName(new SteamLeaderboard_t(id)) };
