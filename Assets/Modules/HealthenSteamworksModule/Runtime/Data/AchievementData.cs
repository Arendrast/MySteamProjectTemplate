...
namespace Heathen.SteamworksIntegration.Modules.HealthenSteamworksModule.Runtime.Data
{
    ...
    public struct AchievementData : IEquatable<AchievementData>, IEquatable<string>, IComparable<AchievementData>, IComparable<string>
    {
        ...
        public readonly bool IsAchieved
        {
            get
            {
                if (StatsAndAchievements.Client.GetAchievement(id, out bool status))
                    return status;
                else
                    return false;
            }
        ...
        public readonly DateTime? UnlockTime
        {
            get
            {
                if (StatsAndAchievements.Client.GetAchievement(id, out _, out DateTime time))
                    return time;
                else
                    return null;
            }
        ...
        {
            bool achieved;
            StatsAndAchievements.Client.GetAchievement(user, id, out achieved);
            return achieved;
        }
        ...
        {
            StatsAndAchievements.Client.GetAchievement(user, id, out bool unlocked, out DateTime time);
        ...
        public readonly void GetIcon(Action<Texture2D> callback) => StatsAndAchievements.Client.GetAchievementIcon(id, callback);
        /// <summary>
