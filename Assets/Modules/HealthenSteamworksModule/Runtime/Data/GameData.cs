...
namespace Heathen.SteamworksIntegration.Modules.HealthenSteamworksModule.Runtime.Data
{
    ...
    public struct GameData : IEquatable<AppId_t>, IEquatable<CGameID>, IEquatable<uint>, IEquatable<ulong>, IEquatable<AppData>, IComparable<AppData>, IComparable<AppId_t>, IComparable<uint>, IComparable<ulong>
    {
        ...
        /// </summary>
        public static GameData Me => Runtime.App.Client.Id;
        /// <summary>
        ...
        /// <returns></returns>
        public readonly bool GetName(out string name) => Runtime.App.Web.GetAppName(App, out name);
        /// <summary>
        ...
        public readonly void GetName(Action<string, bool> callback) => Runtime.App.Web.GetAppName(App, callback);
        /// <summary>
        /// Returns true if the list of App Names have already been loaded
        /// </summary>
        public static bool NamesLoaded => Runtime.App.Web.IsAppsListLoaded;
        /// <summary>
        ...
        public static void LoadNames(Action callback) => Runtime.App.Web.LoadAppNames(callback);
        /// <summary>
