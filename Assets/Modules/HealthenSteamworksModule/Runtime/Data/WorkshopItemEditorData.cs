...
{
    /// <summary>
    /// A helper tool that allows you to pre-define all of the typical fields of a Steam User Generated Content item (aka a Workshop Item) for quick and easy create or update. see the <see cref="UserGeneratedContent.Client.CreateItem(Heathen.SteamworksIntegration.Modules.HealthenSteamworksModule.Runtime.Data.WorkshopItemEditorData,Heathen.SteamworksIntegration.Modules.HealthenSteamworksModule.Runtime.Events.WorkshopItemPreviewFile[],string[],Heathen.SteamworksIntegration.Modules.HealthenSteamworksModule.Runtime.Events.WorkshopItemKeyValueTag[],System.Action{Heathen.SteamworksIntegration.Modules.HealthenSteamworksModule.Runtime.Events.WorkshopItemDataCreateStatus},System.Action{Steamworks.UGCUpdateHandle_t},System.Action{Steamworks.CreateItemResult_t})"/> method for details.
    /// </summary>
    [Serializable]
    public struct WorkshopItemEditorData
    {
        ...
        public bool Create(Action<WorkshopItemDataCreateStatus> completedCallback = null, Action<UGCUpdateHandle_t> uploadStartedCallback = null, Action<CreateItemResult_t> fileCreatedCallback = null) => UserGeneratedContent.Client.CreateItem(this, null, null, null, completedCallback, uploadStartedCallback, fileCreatedCallback);
        /// <summary>
        /// Request the item be created as a new item
        /// </summary>
        ...
        /// <param name="uploadStartedCallback">A delegate of the form (<see cref="UGCUpdateHandle_t"/> handle) that will be invoked when the process has completed its upload phase</param>
        /// <returns>True if the request was accepted</returns>
        public bool Update(Action<WorkshopItemDataUpdateStatus> completedCallback = null, Action<UGCUpdateHandle_t> uploadStartedCallback = null) => UserGeneratedContent.Client.UpdateItem(this, null, null, null, completedCallback, uploadStartedCallback);
        /// <summary>
        ...
        /// <param name="uploadStartedCallback">A delegate of the form (<see cref="UGCUpdateHandle_t"/> handle) that will be invoked when the process has completed its upload phase</param>
        /// <returns>True if the request was accepted</returns>
        public bool Update(WorkshopItemPreviewFile[] additionalPreviews, string[] additionalYouTubeIds, WorkshopItemKeyValueTag[] additionalKeyValueTags, Action<WorkshopItemDataUpdateStatus> completedCallback = null, Action<UGCUpdateHandle_t> uploadStartedCallback = null) => UserGeneratedContent.Client.UpdateItem(this, additionalPreviews, additionalYouTubeIds, additionalKeyValueTags, completedCallback, uploadStartedCallback);
    }
}
#endif