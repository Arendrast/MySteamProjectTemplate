    ...
    public static class Utilities
    {
        ...
        public static class Client
        {
            ...
            static void Init()
            {
                ...
                m_OnKeyboardShown = new();
                m_OnKeyboardClosed = new();
                m_OnAppResumeFromSuspend = new();
            }
...
#pragma warning restore IDE0052 // Remove unread private members
            ...
            public static UnityEvent OnAppResumeFromSuspend
            {
                get
                {
                    if (m_AppResumingFromSuspend_t == null)
                    {
                        ...
                        {
                            m_OnAppResumeFromSuspend.Invoke();
                        });
                    }

                    return m_OnAppResumeFromSuspend;
                }
            }
            public static UnityEvent OnKeyboardShown => m_OnKeyboardShown;
            public static UnityEvent OnKeyboardClosed
            {
                get
                {
                    ...
                    return m_OnKeyboardClosed;
                }
            }

            private static UnityEvent m_OnAppResumeFromSuspend = new();
            private static UnityEvent m_OnKeyboardShown = new();
            private static UnityEvent m_OnKeyboardClosed = new();
