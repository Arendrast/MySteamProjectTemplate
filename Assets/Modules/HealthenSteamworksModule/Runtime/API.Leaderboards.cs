...
namespace Heathen.SteamworksIntegration.Modules.HealthenSteamworksModule.Runtime
{
    public static class Leaderboards
    {
        ...
        public static class Client
        {
            ...
            public static UnityEvent<LeaderboardUGCSet, bool> onUgcAttached = new();
            ...
            public static int PendingFindOrCreateRequests => findOrCreateQueue == null ? 0 : findOrCreateQueue.Count;
            ...
            public static void AttachUGC(LeaderboardData leaderboard, string fileName, byte[] data, Action<LeaderboardUGCSet, bool> callback)
            {
                ...
                RemoteStorage.Client.FileWriteAsync(fileName, data, (writeResult, writeError) =>
                {
                    if(!writeError)
                    {
                        RemoteStorage.Client.FileShare(fileName, (shareResult, shareError) =>
                        {
                            if (!shareError)
                            {
            ...
            public static void AttachUGC(LeaderboardData leaderboard, string fileName, object jsonObject, System.Text.Encoding encoding, Action<LeaderboardUGCSet, bool> callback)
            {
                ...
                RemoteStorage.Client.FileWriteAsync(fileName, jsonObject, encoding, (writeResult, writeError) =>
                {
                    if (!writeError)
                    {
                        RemoteStorage.Client.FileShare(fileName, (shareResult, shareError) =>
            ...
            public static void AttachUGC(LeaderboardData leaderboard, string fileName, string content, System.Text.Encoding encoding, Action<LeaderboardUGCSet, bool> callback)
            {
                ...
                RemoteStorage.Client.FileWriteAsync(fileName, content, encoding, (writeResult, writeError) =>
                {
                    if (!writeError)
                    {
                        RemoteStorage.Client.FileShare(fileName, (shareResult, shareError) =>
