...
namespace Heathen.SteamworksIntegration.Modules.HealthenSteamworksModule.Runtime.ScriptableObjects
{
    /// <summary>
    ...
    public class ItemDefinitionSettings
    {
        ...
        public class LanguageVariantNode
        {
            ...
            public void Populate(SteamItemDef_t itemDefId)
            {
                ...
                {
                    var r = Inventory.Client.GetItemDefinitionProperty(itemDefId, node + "_" + languages[i]);
        ...
        public class PromoRule
        {
            ...
            public void Populate(SteamItemDef_t itemDefId)
            {
                ...
                var results = Inventory.Client.GetItemDefinitionProperty(itemDefId, "promo");
        ...
        public struct Price
        {
            ...
            public struct PriceList
            {
                ...
                {
                    [NonSerialized] public Value[] values;
            ...
            public void Populate(SteamItemDef_t itemDefId)
            {
                var result = Inventory.Client.GetItemDefinitionProperty(itemDefId, "price_category");
                ...
                {
                    result = Inventory.Client.GetItemDefinitionProperty(itemDefId, "price");
                    if (!string.IsNullOrEmpty(result))
                    {
                        usePricing = true;
                        useCategory = false;
        ...
        public class TagCollection
        {
            ...
            public void Populate(SteamItemDef_t itemDefId)
            {
                ...
                var result = Inventory.Client.GetItemDefinitionProperty(itemDefId, "tags");
        ...
        public class TagGeneratorValues
        {
            ...
            public void Populate(SteamItemDef_t itemDefId)
            {
                ...
                var result = Inventory.Client.GetItemDefinitionProperty(itemDefId, "tag_generator_values");
