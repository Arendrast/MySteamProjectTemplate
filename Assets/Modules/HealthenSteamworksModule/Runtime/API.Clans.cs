...
namespace Heathen.SteamworksIntegration.Modules.HealthenSteamworksModule.Runtime
{
    ...
    public static class Clans
    {
        public static class Client
        {
            ...
            static void Init()
            {
                m_OnGameConnectedClanChatMsg = new();
                m_OnGameConnectedChatJoin = new();
                m_OnGameConnectedChatLeave = new();
            ...
            /// </summary>
            public static GameConnectedClanChatMsgEvent OnChatMessageReceived
            {
                get
                {
                    if (m_GameConnectedClanChatMsg_t == null)
                        m_GameConnectedClanChatMsg_t = Callback<GameConnectedClanChatMsg_t>.Create((result) =>
                        {
                            ...
                            m_OnGameConnectedClanChatMsg.Invoke(output);
                        });

                    return m_OnGameConnectedClanChatMsg;
                }
            }
            /// <summary>
            /// Called when a user has joined a Steam group chat that the we are in.
            /// </summary>
            public static GameConnectedChatJoinEvent OnGameConnectedChatJoin
            {
                get
                {
                    if (m_GameConnectedChatJoin_t == null)
                        m_GameConnectedChatJoin_t = Callback<GameConnectedChatJoin_t>.Create((result) =>
                        {
                            ...
                            m_OnGameConnectedChatJoin.Invoke(room, result.m_steamIDUser);
                        });

                    return m_OnGameConnectedChatJoin;
                }
            }
            /// <summary>
            /// Called when a user has left a Steam group chat that the we are in.
            /// </summary>
            public static GameConnectedChatLeaveEvent OnGameConnectedChatLeave
            {
                get
                {
                    if (m_GameConnectedChatLeave_t == null)
                        m_GameConnectedChatLeave_t = Callback<GameConnectedChatLeave_t>.Create((result) =>
                        {
                            ...
                            m_OnGameConnectedChatLeave.Invoke(new UserLeaveData
                            {
                                room = room,
                    ...
                    return m_OnGameConnectedChatLeave;
                }
            }

            private static GameConnectedClanChatMsgEvent m_OnGameConnectedClanChatMsg = new();
            private static GameConnectedChatJoinEvent m_OnGameConnectedChatJoin = new();
            private static GameConnectedChatLeaveEvent m_OnGameConnectedChatLeave = new();
