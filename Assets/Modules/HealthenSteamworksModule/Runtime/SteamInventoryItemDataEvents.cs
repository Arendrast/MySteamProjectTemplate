...
namespace Heathen.SteamworksIntegration.Modules.HealthenSteamworksModule.Runtime
{
    ...
    public class SteamInventoryItemDataEvents : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            Inventory.Client.OnSteamMicroTransactionAuthorizationResponse.AddListener(HandleTransactionAuth);
            Inventory.Client.OnSteamInventoryResultReady.AddListener(HandleInvResultReady);
        }

        private void OnDestroy()
        {
            Inventory.Client.OnSteamMicroTransactionAuthorizationResponse.RemoveListener(HandleTransactionAuth);
            Inventory.Client.OnSteamInventoryResultReady.RemoveListener(HandleInvResultReady);
        }
