...
namespace Heathen.SteamworksIntegration.Modules.HealthenSteamworksModule.Runtime
{
    ...
    public class SteamLobbyJoinOnInvite : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            Matchmaking.Client.OnLobbyInvite.AddListener(HandleInviteReceived);
            Overlay.Client.OnGameLobbyJoinRequested.AddListener(HandleInviteAccepted);
        }

        private void OnDestroy()
        {
            Matchmaking.Client.OnLobbyInvite.RemoveListener(HandleInviteReceived);
            Overlay.Client.OnGameLobbyJoinRequested.RemoveListener(HandleInviteAccepted);
        }
        ...
        private bool CanProcess()
        {
            switch(filter)
            {
                ...
                case FilterMode.IgnoreIfInAny:
                    return Matchmaking.Client.memberOfLobbies.Count == 0;
                default:  return true;
            }
        }
        ...
        private void Preprocess()
        {
            ...
            var lobbies = Matchmaking.Client.memberOfLobbies.ToArray();
        ...
        public void OpenOverlay()
        {
            if (m_Inspector.Data.IsValid)
                Overlay.Client.ActivateInviteDialog(m_Inspector.Data);
            else
