...
namespace Heathen.SteamworksIntegration.Modules.HealthenSteamworksModule.Runtime
{
    ...
    public class GameServerBrowserManager : MonoBehaviour
    {
        ...
        private class Search
        {
            ...
            private void OnRefreshComplete(HServerListRequest hRequest, EMatchMakingServerResponse response)
            {
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    if (serverItem.m_steamID.m_SteamID != 0 && serverItem.m_nAppID == App.Id)
                    {
        ...
        public void GetAllFavorites() => GetServerList(App.Client.Id, GameServerSearchType.Favorites, null, null);
        public void GetAllFriends() => GetServerList(App.Client.Id, GameServerSearchType.Friends, null, null);
        public void GetAllHistory() => GetServerList(App.Client.Id, GameServerSearchType.History, null, null);
        public void GetAllInternet() => GetServerList(App.Client.Id, GameServerSearchType.Internet, null, null);
        public void GetAllLAN() => GetServerList(App.Client.Id, GameServerSearchType.LAN, null, null);
        public void GetAllSpectator() => GetServerList(App.Client.Id, GameServerSearchType.Spectator, null, null);
        public void GetFavorites(Filter filter) => GetServerList(App.Client.Id, GameServerSearchType.Favorites, null, filter);
        public void GetFriends(Filter filter) => GetServerList(App.Client.Id, GameServerSearchType.Friends, null, filter);
        public void GetHistory(Filter filter) => GetServerList(App.Client.Id, GameServerSearchType.History, null, filter);
        public void GetInternet(Filter filter) => GetServerList(App.Client.Id, GameServerSearchType.Internet, null, filter);
        public void GetLAN(Filter filter) => GetServerList(App.Client.Id, GameServerSearchType.LAN, null, filter);
        public void GetSpectator(Filter filter) => GetServerList(App.Client.Id, GameServerSearchType.Spectator, null, filter);
        /// <summary>
